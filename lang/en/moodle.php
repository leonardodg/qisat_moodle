...
$string['unlimited'] = 'Unlimited';
$string['timeAccessSection'] = 'Hour Access Class';
$string['coursehours'] = 'Hour Course';

$string['emailCabecalho'] = '<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="utf-8">
    <style type="text/css">
        ...
        <tr>
            <td style=" padding:20px 20px 16px 20px; line-height:120%">Atenciosamente,<br/><br/>
                ...
                E-mail:<span style="color:#015da2;"> <a href="mailto:qisat@qisat.com.br">qisat@qisat.com.br</a><br/>
                    <i><a href="http://www.qisat.com.br" target="_blank">http://www.qisat.com.br</a></i></span></td>
        </tr>
        <tr>
            <td style="margin:auto; background-color:#4e4e4e; padding:6px; font-family:Tahoma; font-size:11px; color:#979797; margin:auto; text-align:center; height:14px;">© 2003 - 2018 - Todos os Direitos Reservados à MN Tecnologia e Treinamento Ltda. | Para mais informações entre em <a style="color:#cccccc" href="mailto:qisat@qisat.com.br">contato</a>.</td>
        </tr>
    </table>
</div>
</body>
