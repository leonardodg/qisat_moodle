...
class mod_certificate_mod_form extends moodleform_mod {
    ...
    function definition() {
        ...
        $impresso = array( 0 => get_string('no'), 1 => get_string('yes'));
        $mform->addElement('select', 'impresso', get_string('impresso', 'certificate'), $impresso);
        $mform->setDefault('impresso', '0');
        $mform->addHelpButton('impresso', 'impresso', 'certificate');
