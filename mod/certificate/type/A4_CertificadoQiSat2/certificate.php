...
certificate_print_text($pdf, $x + 55, $y + 35, 'L', 'Helvetica', '', 16, 'Conferimos o(a) Sr.(a)');
certificate_print_text($pdf, $x + 55, $y + 44, 'L', 'Helvetica', 'B', 26, mb_strtoupper($nomeAbreviado), 'UTF-8');
...
certificate_print_text($pdf, $x + 120, $y + 74, 'L', 'Helvetica', '', 16, 'Período: ' . date("d/m/Y", $period->timestart) . ' a ' . date("d/m/Y", $period->timeend));
...
certificate_print_text($pdf, $x + 55, $y + 81, 'L', 'Helvetica', '', 16, 'Ambiente: AVA - Ambiente Virtual de Aprendizagem');
