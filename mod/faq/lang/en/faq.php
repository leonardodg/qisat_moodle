...
/**
 * Strings for component 'faq', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    mod_faq
...
$string['externalfaq'] = 'External URL';
$string['framesize'] = 'Frame height';
$string['invalidstoredfaq'] = 'Cannot display this resource, URL is invalid.';
$string['chooseavariable'] = 'Choose a variable...';
$string['invalidfaq'] = 'Entered URL is invalid';
...
$string['page-mod-faq-x'] = 'Any URL module page';
...
$string['serverfaq'] = 'Server URL';
$string['faq:addinstance'] = 'Add a new URL resource';
$string['faq:view'] = 'View URL';
