...
class blocks_gerenciamento_versaoplayer_form extends moodleform {
	...
	function definition() {
		...
		$cursos = $DB->get_records_select('course', "id > 1", null, 'shortname', 'id,shortname');
		...
		$selectAulas .= html_writer::tag('option', get_string('allclasses', 'block_gerenciamento'), array('value'=>'0'));
