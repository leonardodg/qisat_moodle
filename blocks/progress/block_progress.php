    ...
    public function get_content() {
        ...
        // Gather content for block on regular course.
            ...
            if(!isset($this->config)){
                $config = $DB->get_record('block_instances',array('blockname' => 'progress', 'parentcontextid' => $context->id));
                $this->config = unserialize(base64_decode($config->configdata));
                $this->context = context_block::instance($config->id);
            }
