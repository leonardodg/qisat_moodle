...
$string['block/send_question:category:config'] = 'Exibir lista de Categorias para configurar no Bloco Enviar Pergunta';
$string['block/send_question:category:edit'] = 'Editar Categorias no Bloco Enviar Pergunta';
$string['block/send_question:category:delete'] = 'Deletar Categoria no Bloco Enviar Pergunta';
$string['block/send_question:send'] = 'Enviar Mensagem no Bloco Enviar Pergunta';
$string['block/send_question:response'] = 'Responder pergunta no Bloco Enviar Pergunta';
$string['block/send_question:response:list'] = 'Listar Perguntas e Respontas no Bloco Enviar Pergunta';
