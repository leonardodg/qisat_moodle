...
$string['block/send_question:category:add'] = 'Add category in Send Question Block';
$string['block/send_question:category:config'] = 'Show list Category to configure in Send Question block';
$string['block/send_question:category:edit'] = 'Edit Category in Send Question Block';
$string['block/send_question:category:delete'] = 'Delete Category in Send Question Block';
$string['block/send_question:send'] = 'Send Question in Send Question Block';
$string['block/send_question:response'] = 'Response the Question in Send Question Block';
$string['block/send_question:response:list'] = 'List Responses and Questions the Question in Send Question Block';
